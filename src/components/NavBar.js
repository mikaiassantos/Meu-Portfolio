          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/mikaias-da-silva-santos-b3a5ab226/"><img src={navIcon1} alt="Linkedin" /></a>
                <a href="https://www.instagram.com/mikaiassantos_/"><img src={navIcon3} alt="Instagram" /></a>
                <a href="https://github.com/mikaiassantos"><img src={navIcon2} alt="GitHub" /></a>
              </div>
              <HashLink to='#connect'>
